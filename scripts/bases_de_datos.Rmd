...
enaho2019<-
  #modulo5 = base
  m05_2019 %>% select(ids,CODPERSO,P507,P207,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A) %>% 
  #modulo1
  left_join(m01_2019 %>% select(ids,PANEL,NBI4,NBI5,FACTOR07)) %>%
  #modulo3
...
enaho2020<-
  #modulo5 = base
  m05_2020 %>% select(ids,CODPERSO,P507,P207,I520,I538A1,I538E1,OCU500,D524A1,OCUPINF,EMPLPSEC,FAC500A) %>% 
  #modulo1
  left_join(m01_2020 %>% select(ids,PANEL,NBI4,NBI5,FACTOR07)) %>%
  #modulo3
